...
class HomeTo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_home_to)
        ...
        val view_campsites_btn= findViewById<Button>(R.id.view_campsites_btn)
        view_campsites_btn.setOnClickListener {
            val intent = Intent(this, CampSiteBooking::class.java)
            startActivity(intent)
        }
